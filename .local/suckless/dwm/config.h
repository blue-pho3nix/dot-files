...
static char normbgcolor[]           = "#241B30"; // Exterior BG
static char normbordercolor[]       = "#6E29AD";
static char normfgcolor[]           = "#AA54F9";
static char selfgcolor[]            = "#AA54F9";
static char selbordercolor[]        = "#AA54F9";
static char selbgcolor[]            = "#241B30";
...
/* tagging */
static const char *tags[] = { "K", "󰈹", "", "", "", "󰃣", "", "󱎓", "" };
...
//{ MODKEY, 			XK_s,		spawn,			{.v = (const char*[]){ SLOCK, NULL } } },
	...
	{ MODKEY|ShiftMask,		XK_c,          spawn,                  SHCMD("/home/blue/.local/bin/alacritty-here.sh") },
